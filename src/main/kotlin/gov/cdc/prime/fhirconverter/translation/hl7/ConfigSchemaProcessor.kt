...
import gov.cdc.prime.fhirconverter.translation.hl7.schema.ConfigSchema
import gov.cdc.prime.fhirconverter.translation.hl7.schema.ConfigSchemaElement
import gov.cdc.prime.fhirconverter.translation.hl7.utils.CustomContext
import gov.cdc.prime.fhirconverter.translation.hl7.utils.FhirPathUtils
...
abstract class ConfigSchemaProcessor<
    ...
    fun getFocusResources(
        ...
        val resourceList = if (resourceStr == null || resourceStr == "") {
            ...
            FhirPathUtils.evaluate(context, previousFocusResource, bundle, resourceStr)
        }
