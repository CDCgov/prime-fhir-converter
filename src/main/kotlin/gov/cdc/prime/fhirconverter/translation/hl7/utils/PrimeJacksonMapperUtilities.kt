 ...
 */
object PrimeJacksonMapperUtilities {
    /**
     * Time zone to use. Note that Azure runs on UTC, so this forces our local runs to also be UTC.
     */
    val primeTimeZone: ZoneOffset = ZoneOffset.UTC
    ...
    }.run { setTimeZone(TimeZone.getTimeZone(primeTimeZone)) }
