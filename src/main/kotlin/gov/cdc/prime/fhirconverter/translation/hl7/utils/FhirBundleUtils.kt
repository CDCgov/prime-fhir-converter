...
object FhirBundleUtils : Logging {
    ...
    /**
     * Determines if the [targetType] matches any of the options and, if it does, returns the [value] as that type.
     * If not, uses the [logger] to log the [sourceType] and [targetType].
     * Will also log this error if there is an issue with compatibility and the [logIncompatibilityErrors] is true.
     */
