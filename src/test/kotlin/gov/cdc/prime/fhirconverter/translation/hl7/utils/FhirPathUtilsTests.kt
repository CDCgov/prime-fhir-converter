...
// import gov.cdc.prime.fhirconverter.translation.hl7.utils.custom // was trying to pull in a function from somewhere for something
import assertk.all
...
class FhirPathUtilsTests {
    ...
    // todo make decisions on where these tests can live
//    @Test
